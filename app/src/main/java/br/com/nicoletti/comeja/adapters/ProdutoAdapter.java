...
import br.com.nicoletti.comeja.extras.DataUrl;
...
public class ProdutoAdapter extends RecyclerView.Adapter<ProdutoAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder myViewHolder, int position) {
        ...
        int w = 0;
        if (myViewHolder.imgProduto.getLayoutParams().width == FrameLayout.LayoutParams.MATCH_PARENT
                || myViewHolder.imgProduto.getLayoutParams().width == FrameLayout.LayoutParams.WRAP_CONTENT) {
        ...
        Uri uri = Uri.parse("http://www.comeja.com.br/imagens/"+mList.get(position).get("imagemProduto"));
        ...
        myViewHolder.imgProduto.getHierarchy().setRoundingParams(rp);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        SimpleDraweeView imgProduto;
        public TextView tv_nomeProduto;

        public TextView tv_idProduto;
